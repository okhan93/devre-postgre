...
<v-layout justify-center>
    <v-flex xs8>
      ...
      <v-combobox
          ...
          <v-flex xs1 pt-4 mr-1>
          {{price[0].toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 0})}}
        </v-flex>
          <v-flex pt-1 xs4>
          <v-range-slider
          v-model="price"
        ...
        <v-flex xs1 pl-1 pt-4 ml-2>
          {{price[1].toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 0})}}
        </v-flex>
